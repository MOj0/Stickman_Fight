...
export class Material
{
    constructor(options = {})
    {
        ...
        this.metalicRoughnessTexture = options.metalicRoughnessTexture || null;
        this.metalicRoughnessTexCoord = options.metalicRoughnessTexCoord || 0;
        this.metalicFactor = options.metalicFactor !== undefined ? options.metalicFactor : 1;
